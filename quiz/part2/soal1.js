...
function digitPerkalianMinimum(angka) {
    ...
    for (let i = 1; i <= Math.sqrt(angka); i++) {
      if (angka % i === 0) {
        ...
        // gabungkan angka i dan pasangannya jadi satu string, lalu cek panjang stringnya
        let digitGabungan = String(i) + String(pasangan);
        let jumlahDigit = digitGabungan.length;
  
        // update jika ditemukan digit lebih kecil
